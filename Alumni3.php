...
<head>
    ...
    <style>
        ...
        .year-button {
                ...
                margin: 5px;
                cursor: pointer;
                background: linear-gradient(to right, #FC575E, #FFC2D1);
                border: none;
                border-radius: 50px;
                color: white;
                font-weight: bold;
        ...
        .year-button:hover {
                background: linear-gradient(to right, #FFC2D1, #FC575E);
                    ...
                    <div class="Page-Staffs-Details">
                        ...
                        <table class="table-section">
                            ...
                            <tr>
                                ...
                                <td>
                                    ${publication1 ? (linkPub1 ? `<a href="${linkPub1}" target="_blank">${publication1}</a>` : publication1) : ''}
                                    ${publication2 ? (linkPub2 ? `<br><br><a href="${linkPub2}" target="_blank">${publication2}</a>` : `<br><br>${publication2}`) : ''}
                                    ${publication3 ? (linkPub3 ? `<br><br><a href="${linkPub3}" target="_blank">${publication3}</a>` : `<br><br>${publication3}`) : ''}
                                    ${publication4 ? (linkPub4 ? `<br><br><a href="${linkPub4}" target="_blank">${publication4}</a>` : `<br><br>${publication4}`) : ''}
                                    ${publication5 ? (linkPub5 ? `<br><br><a href="${linkPub5}" target="_blank">${publication5}</a>` : `<br><br>${publication5}`) : ''}
                                    ${publication6 ? (linkPub6 ? `<br><br><a href="${linkPub6}" target="_blank">${publication6}</a>` : `<br><br>${publication6}`) : ''}
                                </td>
                            </tr>
                            <tr>
